...
class GettersSpec
  ...
  testSelect[LocalDateTime]("SELECT CAST('2014-12-29 01:02:03.5' AS datetime) --as Joda LocalDateTime)", LocalDateTime.parse("2014-12-29T01:02:03.5").some)

  {
    ...
    //daylight savings.
    val timeString = "2014-12-29T01:02:03.5"
    val localTime = LocalDateTime.parse(timeString)
    val expectedTime = localTime.toDateTime().toInstant
